execute if entity @s[tag=!no_ai] run function luigis_mansion_dark_moon:entities/greenie_boss/ai
...
function luigis_mansion_dark_moon:animations/greenie_boss

execute if entity @s[tag=captured] run function luigis_mansion_dark_moon:entities/greenie_boss/drop_loot