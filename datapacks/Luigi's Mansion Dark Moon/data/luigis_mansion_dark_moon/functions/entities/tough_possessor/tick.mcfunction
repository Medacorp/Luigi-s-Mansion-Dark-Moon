execute if entity @s[tag=!no_ai] run function luigis_mansion_dark_moon:entities/tough_possessor/ai
...
execute if entity @s[tag=lose_layer] run function luigis_mansion_dark_moon:entities/tough_possessor/drop_hearts
execute if entity @s[tag=captured] run function luigis_mansion_dark_moon:entities/tough_possessor/drop_loot