execute if entity @s[tag=!no_ai] run function luigis_mansion_dark_moon:entities/big_polterpup/ai
...
function luigis_mansion_dark_moon:animations/big_polterpup