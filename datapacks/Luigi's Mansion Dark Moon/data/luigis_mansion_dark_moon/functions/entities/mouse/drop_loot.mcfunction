execute if entity @s[tag=!gold] run scoreboard players set #gold_coin Selected 1
execute if entity @s[tag=gold] run scoreboard players set #gold_bar Selected 1
