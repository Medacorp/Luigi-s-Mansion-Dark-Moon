execute if entity @s[tag=!no_ai] run function luigis_mansion_dark_moon:entities/strong_poltergeist/ai
...
execute if entity @s[tag=captured] run function luigis_mansion_dark_moon:entities/strong_poltergeist/drop_loot