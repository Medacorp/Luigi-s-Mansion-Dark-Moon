execute if entity @s[tag=!no_ai] run function luigis_mansion_dark_moon:entities/slammer_boss/ai
...
function luigis_mansion_dark_moon:animations/slammer_boss

execute if entity @s[tag=captured] run function luigis_mansion_dark_moon:entities/slammer_boss/drop_loot