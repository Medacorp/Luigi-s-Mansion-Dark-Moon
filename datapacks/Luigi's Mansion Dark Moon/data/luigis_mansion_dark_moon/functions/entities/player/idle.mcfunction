...
execute if entity @s[scores={IdleTime=80}] run function luigis_mansion_dark_moon:entities/player/animation/should_trigger_dark_room_idle
execute if entity @s[scores={IdleTime=80},tag=!trigger_dark_room_idle] run function luigis_mansion_dark_moon:entities/player/animation/set/idle_lit_room
execute if entity @s[scores={IdleTime=80},tag=trigger_dark_room_idle] run function luigis_mansion_dark_moon:entities/player/animation/set/idle_dark_room
