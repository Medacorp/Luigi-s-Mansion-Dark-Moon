...
scoreboard players remove @s[tag=!paranormal_shield_1,tag=!paranormal_shield_2,tag=!paranormal_shield_3,tag=!infinite_health] Health 250
...
tag @s[tag=paranormal_shield_2] add paranormal_shield_broken
tag @s[tag=paranormal_shield_3] add paranormal_shield_broken