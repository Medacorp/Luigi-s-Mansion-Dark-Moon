execute if entity @s[tag=!gold,tag=!slammer_boss_spawn] run scoreboard players set #gold_coin Selected 1
execute if entity @s[tag=gold,tag=!slammer_boss_spawn] run scoreboard players set #gold_bar Selected 1
