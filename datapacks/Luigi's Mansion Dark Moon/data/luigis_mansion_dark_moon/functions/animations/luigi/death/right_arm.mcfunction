...
execute if entity @s[scores={DeathTime=31..40}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
execute store result score #temp Time run data get entity @s Pose.Head[0] 1
execute if entity @s[scores={DeathTime=31..40}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 3
