...
execute if entity @s[scores={DeathTime=11..50}] store result entity @s Pose.Head[2] float 0.01 run scoreboard players remove #temp Time 125
execute store result score #temp Time run data get entity @s Pose.Head[0] 100
execute if entity @s[scores={DeathTime=11..50}] store result entity @s Pose.Head[0] float 0.01 run scoreboard players add #temp Time 100
