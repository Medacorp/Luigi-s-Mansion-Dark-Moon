...
execute if entity @s[scores={AnimationProg=11..20}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 13
