...
execute as @e[type=minecraft:armor_stand,tag=model_piece,tag=this_sister_berlinda] run function luigis_mansion_dark_moon:animations/sister_berlinda/main
