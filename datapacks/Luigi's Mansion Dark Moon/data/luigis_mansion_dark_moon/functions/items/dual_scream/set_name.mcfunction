...
data modify entity @e[tag=inventory,limit=1] ArmorItems[3].tag.luigis_mansion_dark_moon.items[{tag:{luigis_mansion_dark_moon:{id:"luigis_mansion_dark_moon:dual_scream"}}}].tag merge value {luigis_mansion_dark_moon:{named:1b},display:{Name:'{"italic":false,"color":"white","translate":"luigis_mansion_dark_moon:item.dual_scream"}'}}
