...
execute if entity @s[tag=!being_vacuumed] if data storage luigis_mansion_dark_moon:data ghost_list[-1] run function luigis_mansion_dark_moon:items/poltergust_5000/search_id