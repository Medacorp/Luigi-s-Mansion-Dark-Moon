...
execute unless entity @a[tag=me,limit=1,tag=vacuuming_ghost] run tag @s[tag=vacuumable_object] add in_vacuum
execute if entity @s[tag=vacuumable_object] unless entity @a[tag=me,limit=1,tag=vacuuming_ghost] run function luigis_mansion_dark_moon:items/poltergust_5000/latch_onto_object