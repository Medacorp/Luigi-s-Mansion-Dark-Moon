execute at @s unless entity @e[tag=being_vacuumed,distance=..5,limit=1] facing entity @e[tag=being_vacuumed,sort=nearest,limit=1] feet rotated ~ 0 run teleport @s ^ ^ ^0.2
