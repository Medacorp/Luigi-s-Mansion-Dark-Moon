...
execute if entity @a[tag=me,limit=1,scores={PowerGaugeUsage=1..}] at @s run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/hurt_ghost_power_gauge
execute if entity @a[tag=me,limit=1,scores={PowerGaugeUsage=1..}] unless entity @a[tag=me,limit=1,tag=!poltergust_2x,tag=!poltergust_x3] at @s run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/hurt_ghost_power_gauge
execute if entity @a[tag=me,limit=1,scores={PowerGaugeUsage=1..},tag=poltergust_x3] at @s run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/hurt_ghost_power_gauge
