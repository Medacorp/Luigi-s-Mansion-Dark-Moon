...
execute unless score #temp ID = #temp2 ID if data storage luigis_mansion_dark_moon:data ghost_list[0] run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/search_id