...
execute as @e[tag=ghost,tag=same_room] unless entity @s[tag=!hurt,tag=!flee] run function luigis_mansion_dark_moon:items/poltergust_5000/attacking_ghost
...
execute if score #temp GhostCount matches 1.. if entity @e[tag=ghost,tag=being_vacuumed,tag=!dying] run function luigis_mansion_dark_moon:items/poltergust_5000/face_ghost
...
execute if score #temp GhostCount matches 1.. as @e[tag=ghost,tag=being_vacuumed,tag=!dying] facing entity @s feet run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/ghost
...
execute unless score #temp GhostCount matches 1.. as @e[tag=vacuumable_object,tag=same_room] run function luigis_mansion_dark_moon:items/poltergust_5000/pulling_object
execute unless score #temp GhostCount matches 1.. as @e[tag=vacuumable_object,tag=being_vacuumed] facing entity @s feet run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/object
execute unless score #temp GhostCount matches 1.. if entity @s[tag=!vacuuming_object] if entity @e[tag=can_attach_to_poltergust,distance=..2.5,sort=nearest,limit=1] run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/get_clogged
execute unless score #temp GhostCount matches 1.. if entity @s[tag=!vacuuming_object] unless entity @e[tag=attached_to_poltergust,distance=..2.5,limit=1] run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/default
...
execute unless score #temp GhostCount matches 1.. at @s[tag=vacuuming_object] rotated ~ 0 run function luigis_mansion_dark_moon:items/poltergust_5000/vacuuming/attack_ghost
...
tag @s add vacuuming
execute unless entity @s[tag=!vacuuming_ghost,tag=!vacuuming_object] run scoreboard players remove @s[tag=!no_power_gauge_decrease,scores={PowerGaugeCharge=1..}] PowerGaugeCharge 1
scoreboard players set @s[tag=!vacuuming_ghost,tag=!vacuuming_object] PowerGaugeCharge 0
