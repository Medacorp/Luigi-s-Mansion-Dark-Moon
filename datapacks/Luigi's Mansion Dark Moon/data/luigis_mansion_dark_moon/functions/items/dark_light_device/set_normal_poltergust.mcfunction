...
data modify entity @e[tag=inventory,limit=1] ArmorItems[3].tag.luigis_mansion_dark_moon.items[{tag:{luigis_mansion_dark_moon:{id:"luigis_mansion_dark_moon:dark_light_device"}}}].tag.CustomModelData set value 10
